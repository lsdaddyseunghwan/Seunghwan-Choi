...
2. Manage the domain name routing

3. Implement routing policies in different use case
...
yum install -y wget
cd /var/www/html
wget https://raw.githubusercontent.com/ethantechtorial/norhvirginia/main/index.html
wget https://raw.githubusercontent.com/ethantechtorial/norhvirginia/main/northvirginia.gif
...
yum install -y wget
cd /var/www/html
wget https://raw.githubusercontent.com/ethantechtorial/tokyo/main/index.html
wget https://raw.githubusercontent.com/ethantechtorial/tokyo/main/tokyo.jpg
systemctl start httpd
systemctl enable httpd
```
...
yum install -y wget
cd /var/www/html
wget https://raw.githubusercontent.com/ethantechtorial/paris/main/index.html
wget https://raw.githubusercontent.com/ethantechtorial/paris/main/paris.jpg
systemctl start httpd
systemctl enable httpd
```

#### 4. Create EC2  in "myVPC" named "Local"
...
chkconfig httpd on
cd /var/www/html
wget https://raw.githubusercontent.com/ethantechtorial/local/main/index.html
wget https://raw.githubusercontent.com/ethantechtorial/local/main/local.jpg
service httpd start
systemctl enable httpd
```
...
### STEP 3: Create a Static WebSite Hosting :
 ...
 1. Create Static WebSite Hosting-1/ "www.[your sub-domain name].net"
  ...
  - Upload Files named "index.html" and "error.jpg" in "s3.bucket.www" folder
...
- type "www.example.com". show which content is seen "local instance content" in VPC 
- go to the public browser than type browser: "www.example.com" than show that, N.Virginia instance is seen on public internet.
