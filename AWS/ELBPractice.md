...
- Key Pair - Please select your key pair (pem key) that is created before
...
# https://docs.aws.amazon.com/AWSEC2/latest/UserGuide/configuring-instance-metadata-service.html ------ How Instance Metadata Service Version 2 works
